...
TARGET_BOARD_PLATFORM := msm8953               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := msm8953     # From ro.product.board
...
DEVICE_RESOLUTION := 1280x480                 # The Resolution of your Device
...
BOARD_KERNEL_CMDLINE := console=ttyMSM0,921600,n8 androidboot.console=ttyMSM0 androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.bootdevice=7824900.sdhci earlycon=msm_serial_dm,0x78af000 firmware_class.path=/vendor/firmware_mnt/image androidboot.usbconfigfs=true loop.max_part=7 androidboot.selinux=disabled log_buf_len=4M buildvariant=userdebug
